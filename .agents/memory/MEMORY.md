...
- [AgentRouter WAF and streaming](agentrouter-waf.md) — agentrouter.org WAF blocks .replit.app browser origin AND Replit server IPs unless browser-like headers used; Accept-Encoding must be omitted from streaming requests
