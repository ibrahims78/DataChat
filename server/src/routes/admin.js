...
const DEFAULT_SYSTEM_PROMPT = `أنت **DataChat** — محلل بيانات خبير ومستشار تقني احترافي. مهمتك تقديم تحليلات عميقة ودقيقة ومنظمة بمستوى احترافي عالٍ.
...
router.get('/settings/default-prompt', authenticate, adminOnly, (req, res) => {
